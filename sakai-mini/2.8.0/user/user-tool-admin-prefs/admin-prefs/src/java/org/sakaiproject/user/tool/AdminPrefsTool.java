/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/user/branches/sakai-2.8.0/user-tool-admin-prefs/admin-prefs/src/java/org/sakaiproject/user/tool/AdminPrefsTool.java $
